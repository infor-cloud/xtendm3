...
Once all required information is prepared and the mandatory checklist is completed, create a new ServiceNow ticket under Sold Product: **XtendM3 Review ONLY – do not use for P1**. The Account field should be under the customer's name.
