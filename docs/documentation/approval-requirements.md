...
{: .fs-6 .fw-300 }
Once all required information is prepared and the extension has passed functional testing, create a new ServiceNow ticket under Sold Product: **XtendM3 Review ONLY – do not use for P1**.
...
<div style="background-color: #fff3cd; padding: 10px; border-left: 4px solid #ffc107;">
⚠️ Effective <strong>January 2026</strong>, AI-assisted code review (Amazon Q for Infor) is mandatory for all approval requests and must be included at the time of submission. All identified issues or violations must be resolved before submission.</div>
...
* Project Manager responsible for billing or Certinia project and tasks
